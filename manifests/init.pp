# == Class: greeter_conf
#
# Configure the greeter to use lightdm. 
#
class greeter_conf (
  ...
  validate_string($lightdm_package,$lightdm_config_filepath, $default_display_manager_filepath,$config_dirs_script_filepath,$background_filepath)
